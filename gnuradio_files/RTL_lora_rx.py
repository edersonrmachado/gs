...
class RTL_lora_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "RTL_lora_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTL_lora_rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "RTL_lora_rx")
...
def main(top_block_cls=RTL_lora_rx, options=None):
